...
import com.eja.travelbookingapp.database.DatabaseHelper;
import com.eja.travelbookingapp.session.SessionManager;

import java.util.Calendar;
import java.util.HashMap;

public class BookBisActivity extends AppCompatActivity {

    protected Cursor cursor;
    DatabaseHelper dbHelper;
    SQLiteDatabase db;
    Spinner spinAsal, spinTujuan, spinTanggal, spinDewasa, spinAnak;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_bis);

        dbHelper = new DatabaseHelper(BookBisActivity.this);
        ...
        ArrayAdapter<CharSequence> adapterAsal = new ArrayAdapter<CharSequence>(this, R.layout.support_simple_spinner_dropdown_item, asal);
        adapterAsal.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("jakarta"))
                        ...
                        Toast.makeText(BookBisActivity.this, "Asal dan Tujuan tidak boleh sama !", Toast.LENGTH_LONG).show();
                    } else {
                        AlertDialog dialog = new AlertDialog.Builder(BookBisActivity.this)
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        try {
                                            ...
                                            db.execSQL("INSERT INTO TB_HARGA (username, id_book, harga_dewasa, harga_anak, harga_total) VALUES ('" +
                                                    ...
                                                    hargaTotalAnak + "','" +
                                                    hargaTotal + "');");
                                            Toast.makeText(BookBisActivity.this, "Booking berhasil", Toast.LENGTH_LONG).show();
                                            finish();
                                        } catch (Exception e) {
                                            Toast.makeText(BookBisActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                                        }
                                    }
                                })
                    ...
                    Toast.makeText(BookBisActivity.this, "Mohon lengkapi data pemesanan!", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void setupToolbar() {
        Toolbar toolbar = findViewById(R.id.tbBis);
